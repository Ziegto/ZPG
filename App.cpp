...
void App::createLights()
{
    ...
    cameraLight = new Light(glm::vec3(0.0f, 10.0f, 0.0f), glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 0);
}
...
{
    std::vector<Light*> lights = {light, light2, light3, light4, light5, light6, flashlight, cameraLight};

    std::vector<ShaderProgram*> shaders = {
        shaderPhongTexture, shaderSpherePhong, shaderLambert, shaderConstant, shaderPhong, shaderBlinn, shaderSkyCube,
        shaderPhongNight, shaderPhongTextureNight
    };
...
{
    std::vector<Light*> scene1Lights = {cameraLight, light, light2};
    std::vector<Light*> scene2Lights = {cameraLight, light6, light5, light4};
    std::vector<Light*> scene4Lights = {cameraLight, light, light4};
    ...
    drawableObject2->setMaterial(glowingMaterial);
